...
* BERTopic supports several libraries (Sentence Transformers, Flair, SpaCy, Gensim, USE TF Hub) for encoding our text to dense vector embeddings. Of these, .. Sentence Transformers: https://www.pinecone.io/learn/sentence-embeddings/> library provides the most extensive library of high-performing sentence embedding models. 
